					...
					<div class="col-12">
						...
						<header id="header">
							...
							<nav id="nav">
								...
								<a href="complaintAdmin.php" class="current-page-item">Complaint List</a>
                                ...
                                <div class="row justify-content-center">
                                  ...
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      $sql_for_clint_list="SELECT clint_id,complaint_catagory,complaint_detail,complaint_date,complaint_id ,solve_check FROM complaint_list order by complaint_id ;";
                                      ...
                                      if(mysqli_num_rows($result_as_row) > 0){
                                        while($row = mysqli_fetch_assoc($result_as_row)){ ?>
                                          <tr>
                                            <th scope="row" class="scope" ><?php echo $row["complaint_id"]; ?></th>

                                     ...
                                     <div class="col-12">
                                      ...
                                      <header id="header">
                                       ...
                                       <nav id="nav">
                                        ...
                                        <a href="emp_list.php" class="current-page-item">Employee List</a>
                                ...
                                <div class="table-wrap">
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      $sql_for_emp_list="SELECT empinfo.emp_user,empinfo.last_name,emprole.emp_job_role,emprole.emp_salary,empinfo.emp_phone FROM employee_info AS empinfo,employee_role as emprole WHERE empinfo.emp_user = emprole.emp_user";
                                      ...
                                      if(mysqli_num_rows($result_as_row) > 0){
                                        while($row = mysqli_fetch_assoc($result_as_row)){ ?>
                                          <tr>
                                            <th scope="row" class="scope" ><?php echo $row["emp_user"]; ?></th>
                                            <td><?php echo $row["last_name"]; ?></td>
                                            <td><?php echo $row["emp_job_role"]; ?></td>
                                            <td><?php echo $row["emp_salary"]; ?></td>
                                            <td><?php echo "0".$row["emp_phone"]; ?></td>
                                            </tr><?php
                                          }
                                        }
                                        ?>
